...
router.get('/owner/selection', auth, function (req, res, next) {
...
router.post('/owner/selection', auth, function (req, res, next) {
...
router.get('/owner/engine', auth, function (req, res, next) {
  let states;
  State.find({ gameId: req.query.gameId })
    .populate('comments')
    .sort('-createdAt')
...
router.post('/owner/createState', auth, function (req, res, next) {
...
router.get('/owner/stateEditor', auth, function (req, res, next) {
  let state;
...
router.post('/owner/stateEditor', auth, function (req, res, next) {
